  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <section>
        ...
        <div className="overflow-hidden rounded-sm border border-line bg-panel">
          <label className="flex min-h-14 items-center justify-between gap-4 border-b border-line px-4 py-3">
            <span className="text-sm font-medium">Tiempo objetivo</span>
          ...
          <label className="flex min-h-14 items-center justify-between gap-4 px-4 py-3">
            <span className="text-sm font-medium">Límite de alerta</span>
            <div className="flex items-center gap-2">
              <input
                type="number"
                min={1}
      ...
      <section>
        ...
        <div className="overflow-hidden rounded-sm border border-line bg-panel">
          <label className="flex min-h-14 items-center justify-between gap-4 border-b border-line px-4 py-3">
            <span className="text-sm font-medium">Riesgo medio si llenos ≥</span>
            <input
              type="number"
              min={0}
              step={1}
          ...
          <label className="flex min-h-14 items-center justify-between gap-4 px-4 py-3">
            <span className="text-sm font-medium">Riesgo medio si vacíos ≥</span>
            <input
              type="number"
              min={0}
              step={1}
        ...
        <p className="mt-3 text-xs leading-5 text-muted">
          “Sin espacio” y “Sin rampa” siempre marcan riesgo alto automáticamente,
          sin importar estos valores.
        </p>
      </section>
  ...
  return (
    <div>
      ...
      <main>
        ...
        {activeTab === "permisos" && canManagePermissions && (
